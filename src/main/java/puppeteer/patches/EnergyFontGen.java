...
public class EnergyFontGen {
    public static BitmapFont puppeteerEnergyFont = null;
    ...
    public static void generateGoldFont(FreeTypeFontGenerator.FreeTypeFontParameter param)
    {
        ...
        try
        {
            ...
            param.borderColor = new Color(0.6F, 0.6F, 0.35F, 1.0F);
            puppeteerEnergyFont = (BitmapFont) m.invoke(null,36.0F, true);
        }
        catch (Exception e)
        {
